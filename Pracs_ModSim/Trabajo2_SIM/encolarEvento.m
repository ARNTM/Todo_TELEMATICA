function [ lista_de_eventos ] = encolarEvento( lista_de_eventos, tiempo, tipo, tllegadatarea, numpaquete, taire)
...
%   Detailed explanation goes here
    ...
    if isempty(lista_de_eventos)
        ...
        lista_de_eventos(1,4) = numpaquete;
        lista_de_eventos(1,5) = taire;
        return
    end
    ...
    % El nuevo evento se inserta al final
        ...
        newlista(i+1,4) = numpaquete;
        newlista(i+1,5) = taire;
    end
