...
public class Caperucita extends AbstractGameObject {
    ...
    Caperucita(Caperucita rd) {
        super(rd);    
    }
    
    Caperucita(Position position, int value, int life ) {
        super(position, value, life);    
    }
    
    Caperucita(Position position, int value, int life, ConcurrentLinkedQueue<IGameObject> gObjs) {
        super(position, value, life);    
        this.gObjs = gObjs;
    }
    
    Caperucita(JSONObject jObj) {
