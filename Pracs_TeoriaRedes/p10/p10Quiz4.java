 ...
 * 
 */
public class p10Quiz4 implements IAlgorithm
{
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		op.addDecisionVariable("u_e" , false , new int [] {1 , Efm } , 0 , maximumLinkCapacity);
		...
		op.setObjectiveFunction("minimize" , "c_km * d_e * z_e' + c_Gbps * sum(u_e)"); 
