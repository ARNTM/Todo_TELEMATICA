 ...
 * 
 */
public class ThreeNodesBATemplate_maxThroughput implements IAlgorithm
{
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		op.setObjectiveFunction("maximize" , "h12 + h23 + h13");
		
		/* Add the constraints, excepting the non-negativity which are already enforced */
		op.addConstraint("h12 + h13 <= U");
		op.addConstraint("h23 + h13 <= U");
