...
public class Quiz3 implements IAlgorithm
{
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		final int maxNumHops = Integer.parseInt (algorithmParameters.get ("maxNumHops")); // if you expect a Double, you have to make the conversion
		...
		{
			List<List<Link>> kShortestPaths = GraphUtils.getKLooplessShortestPaths(netPlan.getNodes () , netPlan.getLinks () , d.getIngressNode() , d.getEgressNode() , null , k , -1 , maxNumHops , -1 , -1, -1, -1);
	...
	public List<Triple<String, String, String>> getParameters()
	{
		...
		param.add (Triple.of ("maxNumHops" , "4" , "Maximum number of hops of an admissible path"));
		return param;
	}
}
