 ...
 * 
 */
public class Quiz5 implements IAlgorithm
{
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		op.addDecisionVariable("xx_de" , isNonBifurcated , new int [] {D , E } , 0 , 1);
		...
		op.addConstraint("A_ne * xx_de' == A_nd");
		
		/* Add the link capacity constraints (all links carry less or equal traffic than its capacity) */
		op.setInputParameter("u", netPlan.getVectorLinkCapacity() , "row");
		op.addConstraint("h * xx_de <= u");
		...
		final DoubleMatrix2D x_de = op.getPrimalSolution("xx_de").view2D();
		netPlan.setRoutingFromDemandLinkCarriedTraffic(x_de , true , false);
	...
	public List<Triple<String, String, String>> getParameters()
	{
		...
		param.add (Triple.of ("isNonBifurcated" , "false" , "True if the routing must be constrained to be non-bifurcated"));
		return param;
	}
}
